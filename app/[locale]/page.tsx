        ...
        <div className="flex-1">
          ...
          <div>
            <div className="flex gap-4">
              <Link
                href={"/planner"}
                className="bg-green-600 text-white px-4 py-2 rounded mt-5 text-lg cursor-pointer"
              >
                {t("start_now")}
              </Link>
              <Link
                href={"/destinations"}
                className=" border border-gray-400 px-4 py-2 rounded mt-5 text-lg cursor-pointer"
              >
                {t("learn_more")}
              </Link>
            </div>
